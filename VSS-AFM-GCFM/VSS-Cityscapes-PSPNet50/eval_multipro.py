...
def net_process(net_encoder, net_decoder, pre_image_1, pre_image_2, pre_image_5, cur_image, mean, std=None, flip=True):
...
def scale_process(net_encoder, net_decoder, pre_image_1, pre_image_2, pre_image_5, cur_image, classes, crop_h, crop_w, h, w, mean, std=None, stride_rate=2/3):
    ...
    for index_h in range(0, grid_h):
        for index_w in range(0, grid_w):
            ...
            prediction_crop[s_h:e_h, s_w:e_w, :] += net_process(net_encoder, net_decoder, pre_image_1_crop, pre_image_2_crop, pre_image_5_crop, cur_image_crop, mean, std)
...
def evaluate(net_encoder, net_decoder, loader, args, result_queue):
    ...
    for batch_data in loader:
        ...
        for scale in args.scales:
            ...
            prediction += scale_process(net_encoder, net_decoder, pre_image_1_scale, pre_image_2_scale, pre_image_5_scale, cur_image_scale, args.num_class, crop_h, crop_w, h, w, mean, std)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--scales', default=[1.0], type=int)
