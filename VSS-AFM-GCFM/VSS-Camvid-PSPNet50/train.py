...
def main(args):
    ...
    train_transform = transform.Compose([
        ...
        transform.RandRotate([-10, 10], padding=mean, ignore_label=11),
        transform.RandomGaussianBlur(),
        transform.RandomHorizontalFlip(),
        transform.Crop([360, 480], crop_type='rand', padding=mean, ignore_label=11),
        transform.ToTensor(),
